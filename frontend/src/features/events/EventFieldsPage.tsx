...
type EventFieldsPageProps = { event: EventItem; token: string; onBack: () => void; onSignout: () => void; onCheckIn?: () => void }

export function EventFieldsPage({ event, token, onBack, onSignout, onCheckIn }: EventFieldsPageProps) {
