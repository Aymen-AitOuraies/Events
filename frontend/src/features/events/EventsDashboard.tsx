    ...
    <main className="flex min-h-screen bg-[#eef2ff] text-slate-700">
      ...
      <div className="min-w-0 flex-1 bg-white md:m-4 md:ml-0 md:rounded-2xl md:shadow-xl md:shadow-cyan-950/10">
        <header className="flex h-16 items-center justify-between border-b border-slate-100 px-5 sm:px-7">
          ...
          <div className="flex items-center gap-4"><button title="Notifications" className="text-slate-400 hover:text-cyan-600"><span className="relative block size-2 rounded-full bg-rose-500"><span className="absolute -right-1 -top-1 size-2 animate-ping rounded-full bg-rose-400" /></span></button><span className="hidden text-xs text-slate-400 sm:inline">Welcome back</span><button title="Account" className="text-cyan-700"><UserCircle2 size={23} /></button></div>
        </header>
